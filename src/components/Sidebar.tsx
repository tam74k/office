    ...
    <div className="flex flex-col h-full bg-slate-900 text-white select-none">
      ...
      <div className="p-3 border-b border-slate-800 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white rounded-xl text-xs font-bold transition-all border border-slate-700 cursor-pointer"
        >
